...
<template>
  <div style="padding: 0 10px;">
    ...
    <el-form :inline="true" :model="formInline" class="user-search"  style="display: flex;justify-content: center;align-items: center;">
      ...
      <el-form-item label="" >
        <el-input size="small" clearable v-model.trim="formInline.roleName" placeholder="输入角色名称" ></el-input>
      </el-form-item>
      <el-form-item label="">
        <el-input size="small" clearable v-model.trim="formInline.roleCode" placeholder="输入角色编码"></el-input>
      </el-form-item>
      <el-form-item label="">
        <el-input size="small" clearable v-model.trim="formInline.description" placeholder="输入描述"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="名称" prop="roleName">
          <el-input size="small" v-model="editForm.roleName" auto-complete="off" placeholder="请输入名称"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    fetchData(){
      ...
      selectRole(this.formInline).then(res => {
        console.log(res)
      ...
      this.$refs[editData].validate(valid => {
        if (valid) {
          if(this.isInsertForm) {
            console.log('insertRoleInfo')
            this.insertRoleInfo()
          } else {
            console.log('updateRoleInfo')
            this.updateRoleInfo()
          }
        } else {
          return false
